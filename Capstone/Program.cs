...
//2 - Feed in only read dollar amounts ($1, $2, $20, $100, $10, $5, $50) TIA
//3** - Code for (3) Finish Transaction - while loop (Brandon) - done
//4 - add soldout logic
//5 - Change wording on FeedMoney menu TIA
//6 - Add to upper and to lower in enter product menu BRANDON
//7 - get the log.txt to display feedmoney amounts with the $.00            TIA
